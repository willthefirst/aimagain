...
from src.framework.dispatch.resource_routes import (
    MountError,
    QueryParam,
    ResourceSpec,
    mount_delete,
...
from src.framework.audit.core import AuditAction as _AuditAction  # noqa: E402
from src.framework.audit.core import AuditedResource as _AuditedResource  # noqa: E402
from src.framework.dispatch.entity_spec import EntitySpec as _EntitySpec  # noqa: E402
from src.framework.dispatch.entity_spec import (  # noqa: E402
    RelatedListSubresource as _RelatedSub,
)
from src.framework.dispatch.entity_spec import RouteSet as _RouteSet  # noqa: E402
from src.framework.dispatch.entity_spec import StateAxis as _StateAxis  # noqa: E402
from src.framework.dispatch.entity_spec import Templates as _Templates  # noqa: E402
from src.framework.dispatch.resource_routes import mount_entity  # noqa: E402
        ...
        spec = _EntitySpec(
            ...
            state_axes=(
                _StateAxis(
                    ...
                    action=_AuditAction.SET_USER_ACTIVATION,
                    handler_path=(
                        "src.framework.dispatch.test_resource_routes._stub_axis_handler"
                    ),
                ),
            ),
        )
    ...
    spec = _EntitySpec(
        ...
        state_axes=(
            _StateAxis(
                ...
                action=_AuditAction.SET_USER_ACTIVATION,
                handler_path=(
                    "src.framework.dispatch.test_resource_routes._missing_handler"
                ),
            ),
        ),
    )
