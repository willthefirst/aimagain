...
class ReferralDetail(Base):
    ...
    # Section 3 — description. No post kind has a `subject` column: the
    # title is always derived (`post_feed_headline`) — for referrals from
    # demographics + services — never a poster-set custom string.
