...
register_template_globals(
    ...
    OPENING_SERVICES=enums.OPENING_SERVICES,
    OPENING_SERVICE_LABELS=enums.OPENING_SERVICE_LABELS,
...
register_choice_labels(enums.OPENING_SERVICES, enums.OPENING_SERVICE_LABELS)
